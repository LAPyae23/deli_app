...
const NAV_ITEMS = [
  ...
  { key: 'nav-orders', href: '/customer-dashboard?tab=orders', icon: ClipboardList, label: 'My Orders', badge: null },
  { key: 'nav-cart', href: '/customer-dashboard?tab=cart', icon: ShoppingCart, label: 'Cart', badge: null },
  { key: 'nav-profile', href: '/customer-dashboard?tab=profile', icon: User, label: 'Profile', badge: null },
];
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <Link
              ...
              className={`${isActive ? 'nav-item-active bg-orange-50 text-customer' : 'nav-item'} ${
